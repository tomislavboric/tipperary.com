...
add_image_size( 'featured-xlarge-v2', 1350, 500, true );
add_image_size( 'sign-up-image', 570, 400, true );
add_image_size( 'tabs-image', 380, 280, false );
add_image_size( 'listing-image', 515, 230, true );
// add_image_size( 'gallery-image-medium', 960, 600, true );
add_image_size( 'gallery-image-large', 1170, 730, true );
